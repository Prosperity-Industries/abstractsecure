...
const AdditionalPartyOne = () => {
    const navigate = useNavigate();
    const { toast } = useToast();
    const role = localStorage.getItem('roleInTransaction') || '';
    const partyType = role === 'buyer' ? 'Buyer' : 'Seller';
    const [formData, setFormData] = useState({
        fullName: localStorage.getItem('additionalParty1_fullName') || '',
        dateOfBirth: localStorage.getItem('additionalParty1_dateOfBirth') || '',
        ssn: localStorage.getItem('additionalParty1_ssn') || '',
        maritalStatus: localStorage.getItem('additionalParty1_maritalStatus') || '',
        hasMoreParties: localStorage.getItem('additionalParty1_hasMoreParties') || ''
    });
    const handleInputChange = (e) => {
        ...
        localStorage.setItem(`additionalParty1_${name}`, value);
    };
    const handleSelectChange = (value, field) => {
        ...
        localStorage.setItem(`additionalParty1_${field}`, value);
    };
    ...
    const handleNext = () => {
        ...
        Object.entries(formData).forEach(([key, value]) => {
            localStorage.setItem(`additionalParty1_${key}`, value);
        });
