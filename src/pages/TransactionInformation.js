...
const TransactionInformation = () => {
    ...
    return (_jsx("div", { className: "min-h-screen flex flex-col items-center justify-start p-4 bg-gradient-to-b from-blue-50 to-white", children: _jsxs("div", { className: "w-full max-w-2xl", children: [_jsx("img", { src: "/static/ProsperityAbstract-logo_1972x564.png", alt: "Prosperity Abstract Logo", className: "w-64 mx-auto mb-8" }), _jsx(FormStep, { title: "Transaction Information", currentStep: 1, totalSteps: 2, onNext: handleNext, onPrevious: handlePrevious, nextButtonText: "Next", children: _jsx("div", { className: "space-y-4", children: _jsxs("div", { children: [_jsx(Label, { htmlFor: "roleInTransaction", children: "Role in Transaction" }), _jsxs(Select, { value: role, onValueChange: setRole, children: [_jsx(SelectTrigger, { children: _jsx(SelectValue, { placeholder: "Select your role" }) }), _jsxs(SelectContent, { children: [_jsx(SelectItem, { value: "buyer", children: "Buyer" }), _jsx(SelectItem, { value: "seller", children: "Seller" })] })] })] }) }) })] }) }));
};
